...
<body >
	...
	<div id="navbar-example">
		<ul class="nav nav-tabs">
		    ...
		    <li><a data-toggle="tab" href="#sports">体育军训部</a></li>
	  	</ul>
	</div>
     ...
     style="position: relative;height:auto;">
	    ...
	    <% 
	    if(!stu.getFirstVoteInSport().equals("")){
	    	%>
	    	<h4>您已完成体育军训部老师投票</h4>
	    <%}
	    else{%>
    	<table class="table table-bordered"  id="sportsTable" style="height:auto;">
    	<tbody>
       <% ArrayList<Teacher> list=(ArrayList<Teacher>)session.getAttribute("sportList"); 
       for(int i=0;i<list.size()/3+1;i++){
	       %>
	       <tr>
	       <% 
	...
	<script src="../js/firstVote.js"></script>
</body>
</html>