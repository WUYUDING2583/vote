...
<body>
	<input type="hidden" id="tip" value="f"/>
	<div id="backImg">
		<img src="../pi/2/221f.jpg" class="img-responsive">
	</div>
			...
			<div class="form-group">
				<div class="col-sm-10 col-sm-offset-1">
					<input type="password" class="form-control input-lg" id="password"
						name="password" placeholder="please input your new password">
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-10 col-sm-offset-1">
					<input type="password" class="form-control input-lg"
						id="repassword" placeholder="input your new password again">
				</div>
			</div>
			<div class="form-group">
