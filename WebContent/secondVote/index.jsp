...
<body>
	<div id="backImg">
		<img src="../pi/2/211.jpg" class="img-responsive">
	</div>
	<div class="col-sm-4 col-sm-offset-5" id="window">
	...
	<form role="form" class="form-horizontal" action="../secondIn" method="post">
		...
		<div class="form-group" style="margin-top:30px;">
	  	...
	  	<div class="form-group">
		    <div class="col-sm-offset-1 col-sm-10" style="margin-bottom:30px;">
		      <button type="button" class="btn btn-info btn-block btn-lg" id="login">登录</button>
		    </div>
	  	</div>
	</form>
	</div>
